...
<div align="center">
<!-- banner:start --><a href="https://AnzenKodo.github.io/"><img width="100%" src="https://i.pinimg.com/originals/99/94/bb/9994bbec88cb7cd9d2ab341a2fe55144.jpg" loading="lazy"></a><!-- banner:end -->
</div>
...
- **Status:** <!-- status:start -->Working on AI group project and making app that changes mobile wallpaper from Pinterest saved images .<!-- status:end -->
...
- **Programming Languages:** <!-- languages:start -->[Jupyter Notebook](https://github.com/topics/Jupyter-Notebook) / [HTML](https://github.com/topics/HTML) / [JavaScript](https://github.com/topics/JavaScript) / [CSS](https://github.com/topics/CSS) / [Lua](https://github.com/topics/Lua) / [PHP](https://github.com/topics/PHP) / [Shell](https://github.com/topics/Shell) / [Nunjucks](https://github.com/topics/Nunjucks) / [Nix](https://github.com/topics/Nix) / [Java](https://github.com/topics/Java) / [Python](https://github.com/topics/Python) / [TypeScript](https://github.com/topics/TypeScript) / [SCSS](https://github.com/topics/SCSS)<!-- languages:end -->
